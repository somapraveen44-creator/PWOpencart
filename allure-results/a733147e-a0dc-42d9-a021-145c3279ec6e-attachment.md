...
- Name: VStesting.spec.ts >> vs
- Location: test\VStesting.spec.ts:2:5

# Error details

```
Error: A snapshot doesn't exist at C:\Users\ranga\OneDrive\Desktop\praveen\PW\test\VStesting.spec.ts-snapshots\gst-logo-chromium-win32.png, writing actual.
```
